...
<ul>
  ...
  <li>Developed a dashboard displaying summary statistics and a monthly deposits bar chart using shadcn/ui (Recharts)</li>
  <li>Added filtering and sorting goals using Nuqs</li>
  <li>Added option to export goals as CSV file</li>
