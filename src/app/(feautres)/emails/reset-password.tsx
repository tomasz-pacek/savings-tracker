          ...
          <tr>
            <td align="center">
              <table style={styles.container} cellPadding={0} cellSpacing={0}>
                ...
                <tr>
                  <td style={styles.content}>
                    ...
                    <p style={styles.text}>
                      ...
                      your account. Click the button below to choose a new one.
                    </p>
                    <table
                      cellPadding={0}
                      cellSpacing={0}
                    ...
                    <p style={styles.subtext}>
                      This link expires in <strong>1 hour</strong>. If you
                      didn&apos;t request a password reset, you can safely
                      ignore this — your password won&apos;t change.
                    </p>
                ...
                {/* Security notice */}
                <tr>
                  <td style={styles.notice}>
                    <p style={styles.noticeText}>
                      For your security, this link can only be used once and
